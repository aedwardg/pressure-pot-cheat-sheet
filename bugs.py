# Thanks Michael Uhlenberg (@michaelu123) for providing this Amazing fix for
# "ReferenceError: weakly-referenced object no longer exists" issue on Android
# Link: https://github.com/kivy/kivy/issues/6865
# Note: this may be solved in Kivy 2.0.0, but I have left it in for now.
